...
namespace YaHoApiService.TelegramBot
{
    public class BotSettings
    {
        ...
        public static string WebHookUrl { get; set; } = "https://683115ae9d0f.ngrok.io";    // Part of webhook url that gives ngrok. Command to get it for ssl in IIS Express: ngrok http https://localhost:44360 -host-header="localhost:44360"
